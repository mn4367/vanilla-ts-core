 ...
 * instances that will no longer be used.
 */
...
export interface IChildren {
     ...
     * children inside this collection, e.g. `this.insert(2, this.Children[4], this.Last)`.
     * 
     * __Notes:__
     ...
     * disposed. The component must be considered largely unusable after this operation.
     * @returns This instance.
     */
    clear(): this;
}
